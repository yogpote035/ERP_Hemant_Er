...
/** App footer — company line + build/GSTIN, matching the client mock. */
function AppFooter() {
  return (
    <footer className="mx-auto flex max-w-[1600px] flex-col items-center justify-between gap-1 px-4 pb-5 pt-2 text-[11px] text-faint sm:flex-row sm:px-5 lg:px-6">
      <span>© 2026 Hemant Engineering Works · Pune, MH</span>
      <span className="flex items-center gap-2">
        <span className="rounded bg-muted px-1.5 py-0.5 font-medium text-muted-fg">ERP v4.2</span>
        <span className="mono">GSTIN 27AABCH1234E1Z5</span>
      </span>
    </footer>
  )
}
