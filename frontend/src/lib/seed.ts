...
const PARTS: Part[] = [
  ...REAL_PARTS.map((rp, i): Part => ({
    ...
    avgQtyPerBox: rp.bags,
    active: true,
  })),
  { id: 'p12', partNo: 'DM-1001', materialCode: 'RM-012', description: 'Demo machined hub', unitId: 'u2', uom: 'NOS', hsnSac: '84833000', gstPct: 18, finishWtMg: mg(0.5), scrapWtMg: mg(0.2), avgQtyPerBox: 40, active: true },
  { id: 'p13', partNo: 'DM-1002', materialCode: 'RM-013', description: 'Demo machined flange', unitId: 'u2', uom: 'NOS', hsnSac: '84833000', gstPct: 18, finishWtMg: mg(0.7), scrapWtMg: mg(0.3), avgQtyPerBox: 30, active: true },
]
...
const PRODUCTION: ProductionAttendance[] = [
  { id: 'pa1', unitId: 'u1', date: '2025-02-02', shift: 'A', employeeId: 'e1', machineId: 'm1', partId: 'p3', operationId: 'op-1f', openingCounter: 1000, closingCounter: 2200, okQty: 1180, rateSnapshotPaise: toPaise(2.5), createdBy: ADMIN, createdAt: TS },
]
