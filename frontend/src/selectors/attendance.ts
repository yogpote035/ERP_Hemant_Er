...
/** Pieces made on a production entry. */
export const makeQty = (a: ProductionAttendance): number => Math.max(0, a.closingCounter - a.openingCounter)
...
/** Per-employee earnings across both methods (scoped). */
