...
import { selectScrapRows, selectScrapTotals } from '@/selectors/finance'
import { useCan } from '@/hooks/useCan'
import { toastCommandError, toastCommandSuccess } from '@/lib/commandToast'
import { Badge, Button, Card, ConfirmDialog, EmptyState, Kpi, KpiGrid, SearchableDropdown } from '@/components/ui'
    ...
    <div className="space-y-4">
      ...
      {rows.length === 0 ? (
        ...
        <Card className="overflow-x-auto p-0">
          <div className="border-b border-border px-4 py-3 text-[13px] font-semibold">Recent scrap invoices</div>
