...
import { Badge, Button, Card, ConfirmDialog, Drawer, EmptyState, SearchableDropdown } from '@/components/ui'
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-start gap-3">
        ...
        {can('payments', 'create') ? (
          <Button className="ml-auto" leftIcon={<Plus size={15} />} onClick={() => setRecording(true)} disabled={outstanding.length === 0}>
            Record payment
          </Button>
        ) : null}
      </div>
